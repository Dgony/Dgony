...
* <u>spring이 제공하는 프레임워크 중 디자인패턴 mvc2를 사용하는 프레임워크  
...
```
BookDAO와 BookController 클래스 자체는 팩토리 기법을 구현한 것이 아닙니다.  
...
결합도 낮음 **자스제외공내** 결합도 높음 - 낮으면 좋음   
응집도 낮음 **우논시절교순기** 응집도 높음 - 높으면 좋음 
